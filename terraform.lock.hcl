# Automatically generated by Terraform to track provider versions and integrity.
# Avoid manual changes — this file is managed internally by Terraform.

provider "registry.terraform.io/kreuzwerker/docker" {
  version     = "3.5.0"
  constraints = ">= 3.0, < 4.0"
  hashes = [
    "h1:qXkfTd57rY0sp++8oU+qSeSMLRLLOZu7jWEJONOkwek=",
